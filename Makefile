...
docs:
	...
	nvim --headless -u NONE \
		...
		-c 'lua require("mini.doc").generate({ "lua/pint/init.lua", "lua/pint/ui.lua", "lua/pint/dashboard.lua", "lua/pint/notifier.lua", "lua/pint/statuscolumn.lua", "lua/pint/indent.lua", "lua/pint/words.lua" }, "doc/pint.txt")' \
